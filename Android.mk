...
include $(CLEAR_VARS)
LOCAL_MODULE := quest-discord-scorebot
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"quest-discord-scorebot"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
